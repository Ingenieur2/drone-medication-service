...
class MedicationControllerTest {
    ...
    @DisplayName("Should register a new medication")
    @Transactional
    @Test
    void medicationRegister() throws Exception {
        ...
        medication.setImage(mockMultipartFile.getBytes());

        mockMvc.perform(post("/rest/v1/medication")
                        .param("medication", gson.toJson(medication))
                        .param("image", Arrays.toString(medication.getImage())))
